...
SPREADSHEET_JSON_FILE = "{}/src/getdata/scraping/helpers/covid-chile.json".format(
    BASE_PATH
)
...
INFOGRAM_LINK = "https://infogram.com/cifras-oficiales-coronavirus-1hzj4ozqvvko2pw"
